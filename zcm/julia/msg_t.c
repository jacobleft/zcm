...
int __msg_t_encode_array(void* buf, uint32_t offset, uint32_t maxlen, const msg_t* p, uint32_t elements)
{
    ...
    for (element = 0; element < elements; ++element) {
        ...
        /* str */
        thislen = __string_encode_array(buf, offset + pos_byte, maxlen - pos_byte, &(p[element].str), 1);
...
uint32_t __msg_t_encoded_array_size(const msg_t* p, uint32_t elements)
{
    ...
    for (element = 0; element < elements; ++element) {
        ...
        size += __string_encoded_array_size(&(p[element].str), 1); // str
...
int __msg_t_decode_array(const void* buf, uint32_t offset, uint32_t maxlen, msg_t* p, uint32_t elements)
{
    ...
    for (element = 0; element < elements; ++element) {
        ...
        /* str */
        thislen = __string_decode_array(buf, offset + pos_byte, maxlen - pos_byte, &(p[element].str), 1);
        if (thislen < 0) return thislen; else pos_byte += thislen;
